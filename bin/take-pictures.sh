...
#mosquitto_pub -t "gardyn_01/image/upper_cam" -f /tmp/upper_cam.jpg -u gardyn -P <password>
#mosquitto_pub -t "gardyn_01/image/lower_cam" -f /tmp/lower_cam.jpg -u gardyn -P <password>
